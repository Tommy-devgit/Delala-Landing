        ...
        {!session?.user ? (
          <div className="bg-white rounded-3xl border border-[#ECE7DA] shadow-xl p-8 sm:p-12 text-center space-y-5 max-w-xl mx-auto">
            ...
            <p className="text-xs sm:text-sm text-[#736F4E] max-w-md mx-auto leading-relaxed">
              To list a residential property on Delala, you have to sign in with an existing account or create a new account first.
            </p>
                ...
                <div className="pt-6 border-t border-[#ECE7DA] flex items-center justify-between">
                  ...
                  {currentStep < totalSteps ? (
                    ...
                    >
                      ...
                      <span>{isSubmitting ? "Submitting..." : "Submit for Field Audit →"}</span>
                    </button>
                  )}
                </div>
              </form>
