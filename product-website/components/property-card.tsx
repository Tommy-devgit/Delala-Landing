...
export function PropertyCard({
  ...
  return (
    <Link
      ...
      className="group block bg-white rounded-xl overflow-hidden listing-card-shadow border border-[#ECE7DA] transition-all duration-300 flex flex-col justify-between hover:shadow-md hover:border-[#4C061D]/30"
    >
      <div>
        {/* Full Bleed Compact Image Frame */}
        <div className="relative aspect-[16/11] w-full overflow-hidden bg-[#1c1b12] rounded-t-xl">
          <img
        ...
        <div className="p-3 flex flex-col justify-between">
          <div>
            ...
            <p className="text-[11px] text-[#736F4E] font-medium mb-2.5">
              {property.bedrooms} Bed • {property.bathrooms} Bath • {property.areaSqm}m² • {property.furnished ? "Furnished" : "Unfurnished"}
            </p>
          </div>

          <div className="pt-2 border-t border-[#ECE7DA] flex items-center justify-between">
            <div>
