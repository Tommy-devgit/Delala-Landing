...
export const metadata: Metadata = {
  title: "About Delala | Building Trust in Ethiopian Real Estate",
  description:
    "Delala is digitizing house hunting across Ethiopia by replacing Telegram chaos and middleman fraud with physically verified homes and transparent Birr pricing.",
};
