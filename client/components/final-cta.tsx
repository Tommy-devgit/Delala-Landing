    ...
    <section className="py-16 sm:py-20 lg:py-24 bg-[#FAF8F4] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative bg-[#4C061D] text-white rounded-xl p-8 sm:p-14 lg:p-16 text-center flex flex-col items-center justify-center overflow-hidden shadow-2xl border border-[#B4C292]/40"
        >
          ...
          <div className="relative z-10 max-w-3xl flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-5 w-full max-w-lg">
              <Link
                href="/download"
                className="flex items-center justify-center gap-3 px-8 py-4 rounded-full bg-[#B4C292] text-[#4C061D] font-extrabold text-base shadow-lg hover:bg-white transition-all duration-200 w-full sm:w-auto shrink-0"
              >
              ...
              <div className="flex items-center gap-3 bg-white/10 p-3 px-4 rounded-lg border border-white/20">
