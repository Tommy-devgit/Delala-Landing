      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="hidden md:flex items-center shrink-0 z-10">
            <Link
              href="/download"
              className="inline-flex items-center justify-center px-5 py-2.5 rounded-full bg-[#4C061D] text-white font-bold text-xs sm:text-sm shadow-xs hover:bg-[#3B3923] transition-all duration-200 group active:scale-98"
            >
