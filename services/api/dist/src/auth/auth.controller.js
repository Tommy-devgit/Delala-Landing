...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Register new user via Better Auth integration" }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Authenticate user and issue session token" }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
